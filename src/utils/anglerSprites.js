...
// The window on a frame that a still preview shows: the figure with a hat's worth of
// headroom, without the run of box the rod's longest arc needs. Frame pixels, at the aspect
// the preview boxes in App.css are cut to.
export const STILL_WINDOW = { x: 0, y: 0, w: 180, h: 150 };
