...
const DOCK = {
  ...
  lamp: { x: 32, y: 36, r: 26 },
  // Where a bought decoration stands (utils/dockDecor.js): by the barrel, clear of the crew slots.
  decor: { x: 28, y: 141, scale: 1 },
  sky: [],
  gulls: null,
  dragonflies: [],
  tagAbove: false,
